...
public class Email {
    ...
    private static final String SMTP_AUTH_USER = "quickreporttool@gmail.com"; //your login username/email
    private static final String SMTP_AUTH_PWD  = "QuickReport019283."; //password/secret
